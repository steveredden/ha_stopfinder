...
DEFAULT_MINUTES_BEFORE_HOME_PICKUP   = 25
DEFAULT_MINUTES_AFTER_SCHOOL_DROPOFF = 5
DEFAULT_MINUTES_BEFORE_SCHOOL_PICKUP = 25
DEFAULT_MINUTES_AFTER_HOME_DROPOFF   = 5
